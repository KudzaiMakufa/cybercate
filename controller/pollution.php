    ...
    public function action_index()
    {
       ...
       $dataset = new CsvDataset(DOCROOT."Datasets/attacks.csv", 2, false, ';');
        ...
        foreach (range(1, 10) as $k) {
              ...
              //Debug::dump($sample);die;
               ...
               // Debug::dump($predicted[0]);die;
                ...
                if ($predicted[0] === $dataset->getTargets()[$index]) {
                    ...
                    $attack[$count] = $predicted[0] ;
                   // $array[$correct] = $attack ;
                 //  Debug::dump($predicted[0]);
                    $correct++;
                    /*Debug::dump($attack[$count]);*/
                    $count++ ;
                }
            }
           ...
           // Debug::dump(sprintf('Attack : %s Accuracy (k=%s): %.02f%% correct: %s',$attack[$count], $k, ($correct / count($dataset->getSamples())) * 100, $correct) . PHP_EOL);
